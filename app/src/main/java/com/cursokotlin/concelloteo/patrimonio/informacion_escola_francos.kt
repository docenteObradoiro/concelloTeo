...
class informacion_escola_francos : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        maps.setOnClickListener {
            startActivity(
                Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse("https://www.google.com/maps/place/42%C2%B048'54.5%22N+8%C2%B037'19.1%22W/@42.8151251,-8.624168,17z/data=!3m1!4b1!4m5!3m4!1s0x0:0xb763a8e60fa1d8f6!8m2!3d42.8151251!4d-8.6219793")
                )
            )
        }
        ...
        sonido.setOnClickListener {
            startActivity(
                Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse("https://soundcloud.com/user-261518003/01-escola-de-francos-gal?in=user-261518003/sets/audios-sentir-teo-no-camino")
                )
            )
        }
    }
